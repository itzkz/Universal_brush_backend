...
import com.zkz.universalbrush.model.dto.question.QuestionAddRequest;
import com.zkz.universalbrush.model.dto.question.QuestionEditRequest;
import com.zkz.universalbrush.model.dto.question.QuestionQueryRequest;
import com.zkz.universalbrush.model.dto.question.QuestionUpdateRequest;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> deleteQuestion(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        if (result) {
            questionBankQuestionService.removeByIds(questionBankQuestionService.list(Wrappers.lambdaQuery(QuestionBankQuestion.class).select(QuestionBankQuestion::getId).eq(QuestionBankQuestion::getQuestionId, id)));
        }
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
