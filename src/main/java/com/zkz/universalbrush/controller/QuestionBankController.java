...
import com.zkz.universalbrush.model.dto.questionbank.QuestionBankAddRequest;
import com.zkz.universalbrush.model.dto.questionbank.QuestionBankEditRequest;
import com.zkz.universalbrush.model.dto.questionbank.QuestionBankQueryRequest;
import com.zkz.universalbrush.model.dto.questionbank.QuestionBankUpdateRequest;
...
public class QuestionBankController {
    ...
    public BaseResponse<Boolean> deleteQuestionBank(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        if (result) {
            questionBankQuestionService.removeByIds(questionBankQuestionService.list(Wrappers.lambdaQuery(QuestionBankQuestion.class).select(QuestionBankQuestion::getId).eq(QuestionBankQuestion::getQuestionBankId, id)));
        }
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
