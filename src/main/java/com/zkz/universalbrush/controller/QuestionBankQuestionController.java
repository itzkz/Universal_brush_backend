...
import com.zkz.universalbrush.model.dto.questionbankquestion.*;
import com.zkz.universalbrush.model.entity.QuestionBankQuestion;
import com.zkz.universalbrush.model.entity.User;
import com.zkz.universalbrush.model.vo.QuestionBankQuestionVO;
...
public class QuestionBankQuestionController {
    ...
    public BaseResponse<Long> addQuestionBankQuestion(@RequestBody QuestionBankQuestionAddRequest questionBankQuestionAddRequest, HttpServletRequest request) {
        ...
        if (questionBankQuestionService.getOne(Wrappers.<QuestionBankQuestion>lambdaQuery().eq(QuestionBankQuestion::getQuestionBankId, questionBankId).eq(QuestionBankQuestion::getQuestionId, questionId)) != null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "该题库已添加该题目");
        }
